...
struct EmojiArtDocumentView: View {
    ...
    var body: some View {
        VStack {
            HStack {
                PaletteChooser(document: document, choosenPalette: $chosenPalette)
                    ...
                    Image(systemName: "doc.on.clipboard").imageScale(.large)
                        .alert(isPresented: self.$explainBackgroundPaste) {
                            return Alert(
                                ...
                                message: Text("Copy the URL of an image to the clip board and touch this button to make this the background of your document"),
    ...
    // Note that the use of "$" turns gestureZoomScale into a binding
